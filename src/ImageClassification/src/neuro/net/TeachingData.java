...
public class TeachingData {
    ...
    private Map< String, Map< String, Matrix > > net_inputs;

    public TeachingData(){
        types = new TreeMap< String, Set< String > >();
        net_inputs = new TreeMap< String, Map< String, Matrix > >();
    }
    ...
    public Set< String > getTypes(){
        Set< String > type_set = new TreeSet< String >();
        Set< Map.Entry< String, Set< String > > > set = types.entrySet();
        for( Map.Entry< String, Set< String > > pair : set ){
     ...
     */
    public Set< String > getImages( String type ){
    ...
    public void addImage( String type, String image ){
        ...
        Set< String > images = types.get( type );
    ...
    public Matrix getNetInput( String type, String image ){
        Map< String, Matrix > type_inputs = net_inputs.get( type );
        if ( type_inputs == null )
            return null;
    ...
    public void addNetInput( String type, String image, Matrix input ){
        addImage( type, image );
        Map< String, Matrix > inputs = net_inputs.get( type );
