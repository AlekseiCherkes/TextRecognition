...
//                runTests( net_adapter, "data\\for_recognition", "data\\test_result.txt" );
     ...
     * @param adapter       Interface for work with net.
     ...
     */
     public static void runTests( ReadonlyNetAdapter adapter, String tests_path, String output_path )
            throws Exception{
        ...
        try{
            ...
            for ( String test: tests ){
                RecognizedType type = adapter.recognize( test );
                if ( type == null){
